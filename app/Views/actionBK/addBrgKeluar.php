            ...
            <div class="card-body">
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <select name="selectOptNamaBrg" class="form-control selectpicker" data-live-search="true" id="selectOptNamaBrg">
                    ...
                    foreach ($barang as $key => $value) : ?>
                      <option data-id="<?= $value['namaBarang']; ?>" data-stok="<?= $value['stok']; ?>" data-unit="<?= $value['unit']; ?>" data-supp="<?= $value['supplier']; ?>" data-tokens="<?= $value['namaBarang'] ?>" value="<?= $value['namaBarang'] ?>"><?= $value['namaBarang'] ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                </div>
                ...
                <div class="form-group col-md-1">
                  ...
                  <input name="inputJumlahBrg" type="text" class="form-control" id="inputJumlahBrg" placeholder="">
                </div>
